...
BLOG_AUTHOR = "René Magritte"  # (translatable)
BLOG_TITLE = "This Is Not A Farm"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://thisisnota.farm/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://thisisnota.farm/"
BLOG_EMAIL = "dapinto@gmail.com"
BLOG_DESCRIPTION = "Ce n'est pas une ferme"  # (translatable)
